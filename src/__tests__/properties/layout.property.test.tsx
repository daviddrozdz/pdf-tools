...
vi.mock('next-intl', () => ({
  useTranslations: () => (key: string) => {
    const translations: Record<string, string> = {
      ...
      'buttons.close': 'Close',
      'footer.copyright': '© {year} PDF Toolkit. All rights reserved.',
...
describe('Layout Property Tests', () => {
   ...
   * SHALL contain the brand name "PDF Toolkit" in the header or title area.
   */
  describe('Property 2: Brand Consistency', () => {
    it('Header component displays PDF Toolkit brand name for all locales', () => {
      fc.assert(
        fc.property(
          ...
          (locale) => {
            ...
            expect(brandElement.textContent).toBe('PDF Toolkit');
    ...
    it('Footer component displays PDF Toolkit brand name for all locales', () => {
      fc.assert(
        fc.property(
          fc.constantFrom(...locales),
          (locale) => {
      ...
      fc.assert(
        fc.property(
          ...
          (locale) => {
            ...
            expect(headerBrandText).toBe('PDF Toolkit');
